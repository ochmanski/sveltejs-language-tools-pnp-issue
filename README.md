# sveltejs-language-tools-typescript-pnp-issue

## How does it differ from default sapper-template?

1. Added links to `src/node_modules` in `package.json`.
...
"images": "link:./src/node_modules/images",
```

2. Added `src/routes/about-script-workaround.svelte` to show how to apply the script workaround, to avoid issue `Cannot find type definition file for 'svelte'`.
